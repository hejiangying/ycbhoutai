...
export const otherRouter = {
    ...
    children: [
        ...
        ,
        { path: '/form/activity-manage/detail', title: '线路活动管理详情', name: 'line-detail', component: () => import('@/views/main-module/line-activity/lineActivityDetail.vue') },
        { path: '/info-manage/detail', title: '特产管理详情', name: 'specialty-detail', component: () => import('@/views/main-module/specialty-info/specialtyInfoDetail.vue') }
    ]
};
