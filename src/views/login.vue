    ...
    <Row type="flex" justify="center" align="middle" class="login" @keydown.enter.native="submitLogin">
        <Col :xs="{span:22}" style="width: 368px;">
            <Row class="header">
                ...
                <div class="description">云彩帮后台管理系统</div>
            </Row>
      ...
      if (this.tabName === "username") {
        this.$refs.usernameLoginForm.validate(valid => {
          if (valid) {
            ...
            // var userInfo = {email:"1012139570@qq.com",id:"4363087427670016",mobile:"18782059038",
            //                 roles:[{id:"496138616573953",name:"ROLE_USER"}],username:"test",};
